...
function Login() {
    ...
    const handleSubmit = (e) => {
        ...
        axios({url:"http://" + window.location.hostname + "/api/users/login",method:"post",data:querystring.stringify(credentials),headers:{"Content-Type": "application/x-www-form-urlencoded"}})
    .then((response) => {
